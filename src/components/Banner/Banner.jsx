...
const Banner = () => {
  return (
    <div className={s.banner}>
        <div className={s.banner__first}>
            <div className={s.banner__first_left}>
                <h2 className={s.banner__first_title}>
                    Let’s make things happen
                </h2>
                <p className={s.banner__first_text}>
                    Contact us today to learn more about how our digital marketing services can help your business grow and succeed online.
                </p>
                <a href="">
                    <button className={s.banner__first_btn}>Get your free proposal</button>
                </a>
            </div>       
            <div className={s.banner__first_right}>
        ...
        <div className={s.banner__content}>
            <h2 className={s.banner__content_title}>
                Case Studies
            </h2>
            <p className={s.banner__content_text}>
                Explore Real-Life Examples of Our Proven Digital Marketing Success through Our Case Studies
            </p>
        </div>
        <div className={s.banner__second}>
            <div className={s.banner__second_texts}>
                <div className={s.line}></div>
                <p className={s.banner__second_text}>
                    For a local restaurant, we implemented a targeted PPC campaign that resulted in a 50% increase in website traffic and a 25% increase in sales.
                </p>
                <a href="" className={s.banner__second_link}>
                    Learn More
                    <img src={arrow1} alt="" className={s.banner__second_img} />
                </a>
            </div>
            <div className={s.banner__second_texts}>
                <div className={s.line}></div>
